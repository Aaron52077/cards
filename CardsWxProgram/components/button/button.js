...
export default {
    ...
    data() {
        return [
            {
                type: `topLeft`,
                className: `wuli-ani-dial__top-left`,
            },
            {
                type: `topRight`,
                className: `wuli-ani-dial__top-right`,
            },
            {
                type: `bottomLeft`,
                className: `wuli-ani-dial__bottom-left`,
            },
            {
                type: `bottomRight`,
                className: `wuli-ani-dial__bottom-right`,
            },
            {
                type: `center`,
                className: `wuli-ani-dial__center`,
            }
        ]
    },
	/**
